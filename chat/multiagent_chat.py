...
from diagnostic5 import calculate_loss
import csv
...
if __name__ == "__main__":
    ...
    rounds = 15  # Number of conversational rounds
    for _ in range(rounds):
        ...
        for i in range(len(predefined_questions)):
          ...
          #calculate loss
          bleu_score, conversation = calculate_loss(model, tokenizer, chat_history_bot1, bot1_diag_response, true_answers[i] )
        #   print("Loss: ", loss)
          csv_data.append({
